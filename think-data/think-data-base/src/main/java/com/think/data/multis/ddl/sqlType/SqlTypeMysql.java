...
public class SqlTypeMysql implements IThinkSqlTypeHelper {
    ...
    public String columnBuildSQL(String key, Type type, ThinkColumn annotation) {
        ...
        builder.append("").append(dbType.fixKey(key)).append(" ")
...
//            }
            ...
            builder.append(" DEFAULT ")
                    .append(this.defaultValueString(thinkSqlType,defValue))
                    .append(" ");
        }
