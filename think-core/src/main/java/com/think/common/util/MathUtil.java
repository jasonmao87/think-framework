...
public class MathUtil {
     ...
     * @return 两个参数的商(BigDecimal)
     */
    public static BigDecimal divide(Number v1, Number v2, Integer scale) {
        BigDecimal b1  = new BigDecimal(v1.toString());
        BigDecimal b2 = new BigDecimal(v2.toString());
     ...
     * @return
     */
    public static BigDecimal defaultScaleSet(BigDecimal bigDecimal){
        return bigDecimal.setScale(DEF_DIV_SCALE, BigDecimal.ROUND_HALF_UP);
    }
